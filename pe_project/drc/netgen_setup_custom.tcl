...
# Custom project-specific equivalence: out[19] and scan_out are
# intentionally the same physical net (DFT scan chain design).
join net {-circuit2 out[19]} {-circuit2 scan_out}
